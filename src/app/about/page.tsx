        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-10">
            <div className="rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3305.5!2d-118.3906!3d34.0251!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzTCsDAxJzMwLjQiTiAxMTjCsDIzJzI2LjIiVw!5e0!3m2!1sen!2sus!4v1"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
