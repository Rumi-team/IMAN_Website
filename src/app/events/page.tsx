...
const specialEvents = [
  ...
  },
  {
    ...
    desc: "Annual Muharram programs honoring the legacy of Imam Hussain with lectures, majlis, and community gatherings.",
  ...
  },
  {
    ...
    fa: "عید قربان",
    time: "Dates to be announced",
    desc: "Celebration of Eid al-Adha with congregational prayers, community feast, and charitable giving.",
    color: "bg-[var(--accent)]",
  },
  {
    day: "—",
    ...
    fa: "مبعث",
    time: "Dates to be announced",
    desc: "Commemorating the divine appointment of Prophet Muhammad (PBUH) with special programs and lectures.",
    color: "bg-[var(--lapis)]",
  },
  {
    day: "—",
    ...
    fa: "شب قدر",
    time: "Dates to be announced",
    desc: "The Night of Destiny — join us for night-long worship, supplication, and reflection during the holiest nights of Ramadan.",
    color: "bg-[var(--cypress)]",
  },
];
