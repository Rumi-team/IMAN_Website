...
const wisdoms = [
  ...
  // Imam Ali (AS)
  { en: "The tongue is a beast; if it is let loose, it devours.", fa: "زبان درنده‌ای است که اگر رها شود می‌درد.", author: "Imam Ali (AS)", authorFa: "امام علی (ع)" },
  { en: "Patience is of two kinds: patience over what pains you, and patience against what you covet.", fa: "صبر دو گونه است: صبر بر آنچه ناگوار است و صبر در برابر آنچه دوست داری.", author: "Imam Ali (AS)", authorFa: "امام علی (ع)" },
  { en: "The worth of a man lies in what he does well.", fa: "ارزش هر کسی به اندازه کاری است که نیکو انجام می‌دهد.", author: "Imam Ali (AS)", authorFa: "امام علی (ع)" },
  { en: "Do not let your difficulties fill you with anxiety; after all, it is only in the darkest nights that stars shine more brightly.", fa: "مگذار سختی‌ها تو را مضطرب کند، ستارگان در تاریک‌ترین شب‌ها درخشان‌ترند.", author: "Imam Ali (AS)", authorFa: "امام علی (ع)" },
  // Rumi
  ...
  // Imam Hussain (AS)
  { en: "Death with dignity is better than a life of humiliation.", fa: "مرگ با عزت بهتر از زندگی با ذلت است.", author: "Imam Hussain (AS)", authorFa: "امام حسین (ع)" },
  // Imam Sadiq (AS)
  { en: "The one who has a thousand friends has not a friend to spare, and he who has one enemy will meet him everywhere.", fa: "آن که هزار دوست دارد یک دوست زیادی ندارد و آن که یک دشمن دارد همه جا او را می‌بیند.", author: "Imam Sadiq (AS)", authorFa: "امام صادق (ع)" },
  // Imam Reza (AS)
  { en: "A believer's tongue is behind his heart; he thinks before he speaks.", fa: "زبان مؤمن پشت قلب اوست، پیش از سخن گفتن می‌اندیشد.", author: "Imam Reza (AS)", authorFa: "امام رضا (ع)" },
  // Khayyam
  ...
  // Imam Javad (AS)
  { en: "Trust in God is the price of every precious thing and the ladder to every high destination.", fa: "توکل بر خدا بهای هر چیز گرانبها و نردبان هر مقصد والایی است.", author: "Imam Javad (AS)", authorFa: "امام جواد (ع)" },
  // Nizami
  ...
  // Imam Hassan (AS)
  { en: "The best worship is awaiting relief with patience.", fa: "بهترین عبادت انتظار فرج با صبر است.", author: "Imam Hassan (AS)", authorFa: "امام حسن (ع)" },
  // Extra Prophet Muhammad
  ...
  // Imam Ali
  { en: "A wise man first thinks and then speaks, but a fool speaks first and then thinks.", fa: "انسان دانا نخست می‌اندیشد و سپس سخن می‌گوید، اما نادان نخست سخن می‌گوید و سپس می‌اندیشد.", author: "Imam Ali (AS)", authorFa: "امام علی (ع)" },
  { en: "Your remedy is within you, but you do not sense it.", fa: "درمان تو در درون توست اما احساسش نمی‌کنی.", author: "Imam Ali (AS)", authorFa: "امام علی (ع)" },
  // Rumi extra
...
export default function DailyWisdom() {
  ...
  useEffect(() => {
    const dayIndex = getDayOfYear() % wisdoms.length;
